...
### v0.21 (2024-XX-XX)
- **新增功能**: 合成语音列表功能
- **界面优化**: 仿照录音机App设计界面，支持按时间倒序排列语音文件
- **音频管理**: 支持播放/暂停、重命名和删除合成的语音文件
- **播放控制**: 支持音频进度条显示和控制
- **存储优化**: 将电子书和合成语音统一保存在外部Documents目录
- **统一存储**: 所有文本文件（包括新建文本）现在统一保存在`Documents/WanderReads/books`目录下
- **界面修复**: 修复书架页面顶部导航栏显示异常的问题，增强视觉对比度和可见性
- **主题优化**: 优化深色主题下的状态栏和导航栏配色，提升整体视觉体验
- **优化体验**: 卸载应用后不会丢失已创建的文本内容

### v0.20 (2024-XX-XX)
- **新增功能**: 将电子书文件存储位置从应用私有目录迁移到外部Documents目录
- **优化存储**: 电子书、封面图片和网页导入的内容现在保存在`Documents/WanderReads/`目录下
- **改进体验**: 卸载应用后不会丢失已导入的电子书和相关数据
- **权限管理**: 为Android 10及以上版本添加了必要的外部存储访问权限处理
...
- 语音文件按照生成时间倒序排列，显示文件名、生成时间、时长、文件大小
